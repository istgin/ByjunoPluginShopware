...
function Cembrapay_CreateShopRequestS4($documentId, $amount, $orderAmount, $orderCurrency, $orderId, $customerId, $date)
{
...
function Cembrapay_CreateShopRequestS5Refund_DB($documentId, $amount, $orderCurrency, $orderId, $customerId, $date)
{
    $sql     = '
            INSERT INTO s_plugin_byjuno_documents (document_id, amount, order_amount, order_currency, order_id, customer_id, date, document_type, document_sent, document_try_time)
                    VALUES (?,?,?,?,?,?,?,?,?,?)
...
function Cembrapay_CreateShopRequestS5Refund($documentId, $amount, $orderCurrency, $orderId, $customerId, $date)
{
...
function Cembrapay_CreateShopRequestS5Cancel_DB($amount, $orderCurrency, $orderId, $customerId, $date)
{
    $sql     = '
            INSERT INTO s_plugin_byjuno_documents (document_id, amount, order_amount, order_currency, order_id, customer_id, date, document_type, document_sent, document_try_time)
                    VALUES (?,?,?,?,?,?,?,?,?,?)
...
function Cembrapay_CreateShopRequestS5Cancel($amount, $orderCurrency, $orderId, $customerId, $date)
{
