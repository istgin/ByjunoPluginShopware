...
function Byjuno_CreateShopWareShopRequestUserBilling($user, $billing, $shipping, $controller, $paymentmethod, $repayment, $invoiceDelivery, $riskOwner, $orderId = "", $orderClosed = "NO", $transactionNumber = "") {
    ...
    $extraInfo["Value"] = 'Byjuno ShopWare module 1.3.2';
    $request->setExtraInfo($extraInfo);
    return $request;
...
function Byjuno_CreateShopWareShopRequestUserBillingCDP($user, $billing, $shipping, $amount, $paymentmethod, $repayment, $invoiceDelivery, $riskOwner, $orderId = "", $orderClosed = "NO") {
