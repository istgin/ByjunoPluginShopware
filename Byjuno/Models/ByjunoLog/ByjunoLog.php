...
namespace Shopware\CustomModels\ByjunoLog;
 ...
 * @ORM\Table(name="s_plugin_byjuno_log")
 */
class ByjunoLog extends ModelEntity
{
   ...
   *
   * @param \Shopware\CustomModels\ByjunoLog\ByjunoLog $apiLog
   */
  public function addApiLog(\Shopware\CustomModels\ByjunoLog\ByjunoLog $apiLog)
  {
    $this->apiLogs[] = $apiLog;
  }
