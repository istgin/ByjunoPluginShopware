...
//{namespace name=backend/byjuno_log/main}
/**
 * Shopware UI - Log view list
 *
 * This grid contains all logs and its information.
 */
//{block name="backend/byjuno_log/view/log/list"}
Ext.define('Shopware.apps.ByjunoLog.view.log.List', {
  /**
    ...
    return Ext.create('Ext.selection.RowModel', {
      listeners: {
        selectionchange: function(view, selected) {
          if(selected[0])
          {
            me.detail = Ext.create('Shopware.apps.ByjunoLog.view.main.Detailwindow', {
