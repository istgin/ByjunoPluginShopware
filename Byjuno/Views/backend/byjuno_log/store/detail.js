 ...
 */
//{block name="backend/byjuno_log/store/detail"}
Ext.define('Shopware.apps.ByjunoLog.store.Detail', {
  /**
  ...
  model: 'Shopware.apps.ByjunoLog.model.Grid2cols',
  /**
  ...
  proxy: {
     ...
     */
    api: {
      read: '{url controller="ByjunoLog" action="getGridData"}',
    },
    /**
